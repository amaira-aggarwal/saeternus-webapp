...
const courses: CourseInfo[] = [
  ...
  {
    courseId: '6',
    title: 'AI for Research Methodology',
    header: 'Certificate Course in AI for Research Methodology',
    image: '/assets/ResearchDesignWriting.png',
    tags: ['Research Methodology', 'AI', 'Project'],
    prevPrice: '₹8,200',
    currentPrice: '₹2,950',
    path: 'ai-research-methodology',
    aliases: [
...
const detailedCourses: CourseDetails[] = [
  ...
  },
  {
    ...
    title: 'AI for Research Methodology',
    description:
      "Use AI-powered tools to support and enhance every stage of the research journey, from identifying and refining a strong topic, framing research questions, and conducting a more efficient literature review, to planning an appropriate methodology and organizing your study design. Learn how AI can assist with data handling tasks such as structuring, cleaning, and summarizing information, and how it can support analysis and interpretation by helping you explore patterns, check consistency, and communicate findings more clearly. Throughout the course, you'll focus on responsible and practical use of AI in research, understanding what to trust, how to verify outputs, and how to apply these tools ethically and effectively to produce stronger, clearer research work.",
    image: '/assets/ResearchDesignWriting.png',
    tags: ['Research Methodology', 'AI', 'Research'],
    prevPrice: '₹8,200',
    currentPrice: '₹2,950',
    ...
    keywords: [
      ...
      'systematic literature review with AI',
      'research gap identification using AI',
      'research problem formulation with AI',
      'research topic selection using AI',
      'research question formulation',
      'hypothesis building with AI',
      'variable identification with AI',
      'study design with AI',
      'research design course',
      'sampling techniques course',
      'data collection methods',
      'survey design with AI',
      'questionnaire design with AI',
      'interview questions with AI',
      'qualitative research with AI',
      'field notes analysis with AI',
      'thematic analysis with AI',
      'coding qualitative data with AI',
      ...
      'beginner research methodology',
      'research methodology for students',
      'research methodology for PhD',
      'research methodology for masters students',
      'research methodology for academics',
